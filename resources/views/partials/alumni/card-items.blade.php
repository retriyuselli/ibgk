@foreach ($alumni as $person)
    ...
    >
        <div class="relative overflow-hidden">
            {!! site_image_or_storage($person->photo, 'images/home/alumni-placeholder.jpg', $person->name, ['class' => 'aspect-[3/4] w-full object-cover transition duration-300 group-hover:scale-[1.02]']) !!}
        ...
        <div class="px-3 py-3 sm:px-4 sm:py-4">
            <h4 class="text-sm font-semibold text-navy transition group-hover:text-gold sm:text-base">{{ $person->name }}</h4>
