...
use App\Services\ResolveParticipantForUser;
...
class DashboardController extends Controller
{
    public function __construct(
        ...
        private ResolveParticipantForUser $resolveParticipantForUser,
    ) {}

    public function __invoke(): View
    {
        $user = Auth::user();
        $participant = $this->resolveParticipantForUser->handle($user);
