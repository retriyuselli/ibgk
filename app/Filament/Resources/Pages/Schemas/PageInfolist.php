    ...
    public static function configure(Schema $schema): Schema
    {
        return $schema->components([
            Section::make('Detail Halaman')->columns(2)->schema([
                ...
                ImageEntry::make('about_image_1')->label('Foto Tentang 1')->disk('public')->visible(fn ($record): bool => $record?->slug === 'about'),
                ImageEntry::make('about_image_2')->label('Foto Tentang 2')->disk('public')->visible(fn ($record): bool => $record?->slug === 'about'),
                ImageEntry::make('about_image_3')->label('Foto Tentang 3')->disk('public')->visible(fn ($record): bool => $record?->slug === 'about'),
                ImageEntry::make('about_image_4')->label('Foto Tentang 4')->disk('public')->visible(fn ($record): bool => $record?->slug === 'about'),
